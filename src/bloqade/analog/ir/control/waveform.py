...
class Waveform(HashTrait, CanonicalizeTrait):
    ...
    - [`<instruction>`][bloqade.analog.ir.control.waveform.Instruction]
    - [`<smooth>`][bloqade.analog.ir.control.waveform.Smooth]
    - [`<slice>`][bloqade.analog.ir.control.waveform.Slice]
    - [`<apppend>`][bloqade.analog.ir.control.waveform.Append]
    - [`<negative>`][bloqade.analog.ir.control.waveform.Negative]
    - [`<scale>`][bloqade.analog.ir.control.waveform.Scale]
    - [`<add>`][bloqade.analog.ir.control.waveform.Add]
    - [`<record>`][bloqade.analog.ir.control.waveform.Record]
    - [`<sample>`][bloqade.analog.ir.control.waveform.Sample]
...
class Instruction(Waveform):
    ...
    - [`<linear>`][bloqade.analog.ir.control.waveform.Linear]
    - [`<constant>`][bloqade.analog.ir.control.waveform.Constant]
    - [`<poly>`][bloqade.analog.ir.control.waveform.Poly]
    - [`<python-fn>`][bloqade.analog.ir.control.waveform.PythonFn]
