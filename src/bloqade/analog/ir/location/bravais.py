...
class BoundedBravais(AtomArrangement):
    ...
    [`AtomArrangement`][bloqade.analog.ir.location.base.AtomArrangement].

    - [`Square`][bloqade.analog.ir.location.bravais.Square]
    - [`Chain`][bloqade.analog.ir.location.bravais.Chain]
    - [`Honeycomb`][bloqade.analog.ir.location.bravais.Honeycomb]
    - [`Triangular`][bloqade.analog.ir.location.bravais.Triangular]
    - [`Lieb`][bloqade.analog.ir.location.bravais.Lieb]
    - [`Kagome`][bloqade.analog.ir.location.bravais.Kagome]
    - [`Rectangular`][bloqade.analog.ir.location.bravais.Rectangular]
